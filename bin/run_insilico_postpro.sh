...
echo "run in-silico"
"./drug_sim" -input_deck ./input_deck.txt -hill_file ./drugs/$drugname/IC50_samples100.csv -herg_file ./herg/$drugname.csv
...
"./drug_sim" -input_deck ./input_deck.txt -hill_file ./drugs/$drugname/IC50_samples100.csv -init_file ./result/$formatted_concentration.csv -herg_file ./herg/$drugname.csv
new_value="0"
sed -i.old "s/^\(Is_Post_Processing = \).*/\1$new_value/" "./input_deck.txt"
